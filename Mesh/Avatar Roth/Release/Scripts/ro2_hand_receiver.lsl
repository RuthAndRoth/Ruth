            ...
            if (channel == r2chan)
            {
                ...
                if (listLenght >= 3)
                {
                    ...
                    } else if (command == "ALPHA")
                    {
                        ...
                        {
							if (face2change == -1 || face2change == 2) //added to hide toenails when hiding foot or toe
										{
											list primcolorlist0 = llGetLinkPrimitiveParams(2,[PRIM_COLOR, 0]);
											list primcolorlist1 = llGetLinkPrimitiveParams(2,[PRIM_COLOR, 1]);
											vector oldprimcolor0 =llList2Vector(primcolorlist0,0);
											vector oldprimcolor1 =llList2Vector(primcolorlist1,0);
											llSetLinkPrimitiveParamsFast(2, [PRIM_COLOR, 0, oldprimcolor0, alphaval]);
											llSetLinkPrimitiveParamsFast(2, [PRIM_COLOR, 1, oldprimcolor1, alphaval]);
											llSetLinkPrimitiveParamsFast(2, [PRIM_COLOR, 2, <1.0,1.0,1.0>, alphaval]);
										}
